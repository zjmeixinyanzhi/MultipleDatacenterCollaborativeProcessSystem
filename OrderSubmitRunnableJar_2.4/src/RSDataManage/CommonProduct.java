...
public class CommonProduct extends DataEntity
{
	...
	*/
	...
	public CommonProduct(Integer id, String name, java.util.Date date,
			String hostName,String innerPrefix, long innerSuffix,long mD5Code,
...
//	}
	...
	public long getInnerSuffix(){
		return InnerSuffix;
	}
	
	public void setInnerSuffix(long innerSuffix){
		InnerSuffix = innerSuffix;
	}
