...
public class ProcessImplServiceLocator extends org.apache.axis.client.Service implements ServiceInterface.ProcessImplService {
    ...
    public ProcessImplServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for ProcessImpl
    private java.lang.String ProcessImpl_address = "http://10.3.10.1:10080/Project1Webservice/services/ProcessImpl";
    ...
    public ServiceInterface.ProcessImpl getProcessImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ServiceInterface.ProcessImplSoapBindingStub _stub = new ServiceInterface.ProcessImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ServiceInterface.ProcessImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                ServiceInterface.ProcessImplSoapBindingStub _stub = new ServiceInterface.ProcessImplSoapBindingStub(new java.net.URL(ProcessImpl_address), this);
                _stub.setPortName(getProcessImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ServiceInterface", "ProcessImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ServiceInterface", "ProcessImpl"));
        }
