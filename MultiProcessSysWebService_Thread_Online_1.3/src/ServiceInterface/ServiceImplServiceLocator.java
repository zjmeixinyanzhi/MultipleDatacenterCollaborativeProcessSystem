...
public class ServiceImplServiceLocator extends org.apache.axis.client.Service implements ServiceInterface.ServiceImplService {
    ...
    private java.lang.String ServiceImpl_address = "http://localhost:8080/MCAInterface/services/ServiceImpl";
    ...
    public ServiceInterface.ServiceImpl getServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ServiceInterface.ServiceImplSoapBindingStub _stub = new ServiceInterface.ServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ServiceInterface.ServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                ServiceInterface.ServiceImplSoapBindingStub _stub = new ServiceInterface.ServiceImplSoapBindingStub(new java.net.URL(ServiceImpl_address), this);
                _stub.setPortName(getServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ServiceInterface", "ServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ServiceInterface", "ServiceImpl"));
        }
