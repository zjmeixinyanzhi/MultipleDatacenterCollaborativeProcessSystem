...
public class RSDataRequestInfo {
	...
	public void insertRequestInfo(String datacenter, String filepath) {
		System.out
		.println("RSData::public void insertRequestInfo(String datacenter, String filepath) | 插入数据缓存信息");
...
//			this.filepath += "&";
	...
	public String getDataRequestInfoString() {
		System.out
		.println("RSData::public String getDataRequestInfoString() | 获取当前数据缓存信息字符串");
